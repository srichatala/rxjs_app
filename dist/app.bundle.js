...
/***/ function(module, exports, __webpack_require__) {
	...
	var btn = (0, _jquery2.default)('#btnClick');

	var btn$ = _Rx2.default.Observable.fromEvent(btn, 'click');
	...
	var input = (0, _jquery2.default)('#value');
	...
	var mover$ = _Rx2.default.Observable.fromEvent(document, 'mousemove');

	mover$.subscribe(function (e) {
